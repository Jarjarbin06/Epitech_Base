...
sidebar: sidebar
permalink: lib_newcsfml_doc_modules_audios_sound.html
folder: docs
---

# 📦 Sound Module (`nsf_sound`)
#### part of [Audios](lib_newcsfml_doc_modules_audios.md)
...
* [`nsf_utils` 🔗](lib_newcsfml_doc_modules_systems_utils.md)
