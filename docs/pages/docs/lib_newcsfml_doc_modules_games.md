...
sidebar: sidebar
permalink: lib_newcsfml_doc_modules_games.html
folder: docs
---
...
* [Event](lib_newcsfml_doc_modules_games_event.md) — Event managing
* [Keyboard](lib_newcsfml_doc_modules_games_keyboard.md) — Keyboard managing
* [Mouse](lib_newcsfml_doc_modules_games_mouse.md) — Mouse managing
* [Game](lib_newcsfml_doc_modules_games.md) — Main ownership structure
* [Window](lib_newcsfml_doc_modules_games_window.md) — Core rendering system
* [Window Settings](lib_newcsfml_doc_modules_games_window_settings.md) — Rendering settings
