...
sidebar: sidebar
permalink: lib_newcsfml_doc_modules_audios.html
folder: docs
---
...
* [Music](lib_newcsfml_doc_modules_audios_music.md) — Streamed audio playback (background tracks)
* [Sound](lib_newcsfml_doc_modules_audios_sound.md) — Buffered sound effects (short audio)
